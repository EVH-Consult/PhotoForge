...
provided modification-time value through UTC, truncates it to second precision,
and stores an explicit zero offset. It returns one `datetime`-precision candidate with
